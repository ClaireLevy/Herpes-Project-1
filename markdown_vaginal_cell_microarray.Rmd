...
CELLSesetSel1<-expressedProbes.lumi[CELLSselected1,targets$Time=="3"& targets$Treatment !="SD90" ]
...
colnames(exprs(CELLSesetSel1))<-pData(expressedProbes.lumi)[colnames(CELLSesetSel1),"Treatment"]
...
CELLSesetSel2<-expressedProbes.lumi[CELLSselected2,targets$Time=="8"& targets$Treatment !="SD90" ]

colnames(exprs(CELLSesetSel2))<-pData(expressedProbes.lumi)[colnames(CELLSesetSel2),"Treatment"]
...
CELLSesetSel3<-expressedProbes.lumi[CELLSselected3,targets$Time=="24"& targets$Treatment !="SD90" ]

colnames(exprs(CELLSesetSel3))<-pData(expressedProbes.lumi)[colnames(CELLSesetSel3),"Treatment"]
...
getUP<-function(df){
 ...
 df["logFC">0, c("ENTREZ_GENE_ID", "logFC", "adj.P.Val")]
}
