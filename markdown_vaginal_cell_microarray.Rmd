...
save(RdataOutput/CELLSexpressedProbes.lumi, file="CELLSexpressedProbes.lumi.Rdata")
```
...
save(results, file= "RdataOutput/CELLSdecideTestsResults.Rdata")
...
save(CELLSttList, file = "RdataOutput/CELLSttList.Rdata")

ProbeIDandSymbol<-fData(RAW.lumi)[,c(1,4,7)]

save(ProbeIDandSymbol, file="RdataOutput/CELLSProbeIDandSymbol.Rda")
...
save(CELLSV186UP, file="CELLSV186UP.Rdata")
#get downreg      
CELLSV186DOWN<-lapply(CELLSshortTTlist,FUN=getDOWN)
save(CELLSV186DOWN, file = "CELLSV186DOWN.Rdata")
