...
6= One of the T-cell samples, not included in explant study
33=ID326 T1 M
34=ID 326 T2 V1
35=ID 326 T3 V2
36 ID 317 T2 M
...
##I put the above file into innateDB with the "subset of genes", "hypergeometric" and "no correction" options for the pathway ORA.
...
#for innateDB
DownV186.24<-as.numeric(DownRegProbes[[3]])
write.table(DownV186.24, "DownV186.24.txt", sep="\t", row.names = FALSE)
