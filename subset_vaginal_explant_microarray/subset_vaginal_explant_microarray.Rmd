...
save(subset_complete.RAW.lumi,file="subset_vaginal_explant_microarray/subset_complete.RAW.lumi.Rdata")
...
save(QNTB.complete.RAW.lumi, file = "subset_vaginal_explant_microarray/subset_QNTB.complete.RAW.lumi.Rdata")
```
...
save(expressedProbes.lumi, file="subset_expressedProbes.lumi.Rdata")
```
...
save(fit, file="subset_vaginal_explant_microarray/subset_fit.Rdata")
...
write.table(meltSummary, file="subsetMeltSummaryData.txt")
...
subsetGeneFolder <- "J:/MacLabUsers/HLADIK SHARED/Projects/Herpes study/Herpes-Project-1/subset_vaginal_explant_microarray/SUBSET INNATE DB RESULTS/geneSpreadsheets"
...
write.table(forExcelShortGeneIDBdata, file = "SUBSETforExcelShortGeneIDBdata.txt", sep = "\t", row.names=FALSE)


###### I opened this file in Excel and made a few excel mogrification fixes, and called it "subsetIDBGenesV186" and put it in 

#J:\MacLabUsers\HLADIK SHARED\Projects\Herpes study\Herpes-Project-1\subset_vaginal_explant_microarray\INNATE DB RESULTS\Excel for FH based on geneSpreadsheets
